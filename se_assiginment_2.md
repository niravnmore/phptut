...
4. **Increment/Decrement Operators:** Increase or decrease a variable's value by 1.
- `++` Increment operator
- `--` Decrement operator
```c
int count = 0;
...
6. **Conditional Operators:** Simplifies simple if-else statements. `condition ? value_if_true : value_if_false`.
```c
int a = 10, b = 20;
